...
const AuthPage = () => {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center p-6 overflow-hidden">
      ...
      <div className="relative z-10 flex w-full max-w-6xl min-h-[85vh] overflow-hidden rounded-2xl border border-white/15 shadow-2xl bg-card/90 backdrop-blur-sm">
        {/* Left Panel - Form */}
